...
{      
    int i;
		...
		NuiTransformSkeletonToDepthImage(skel.SkeletonPositions[2], &x, &y, &depth);
		...
		SetDlgItemInt(m_hWnd, IDC_Y_coord, (UINT32)y_comp, TRUE);
		SetDlgItemInt(m_hWnd, IDC_Z_coord, (UINT32)depth, TRUE);
