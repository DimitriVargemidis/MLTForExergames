...
\title{Design and implementation of\phantom{tj}\\
a user interface for controlling computer games\phantom{tj}\\
using a Kinect camera as part of\phantom{tj}\\
physical therapy}
\subtitle{ }
...
\promotorA[Promotor]{prof.\ dr.\ ir.\ L.\ Geurts}
\promotorB[Co-promotor]{ir.\ K.\ Vanderloock}
